...
const c = {
  ...
  mainRow:
    "flex w-full max-w-7xl flex-col items-center gap-5 px-4 py-4 text-white md:flex-row md:items-start md:justify-between md:gap-6 md:px-6 md:py-5 lg:gap-8 lg:px-8 lg:py-6 xl:gap-10 xl:px-10",
  ...
  bottom:
    "flex w-full max-w-7xl flex-col items-center gap-1.5 px-4 text-center text-white md:px-6 lg:px-8 xl:px-10",
